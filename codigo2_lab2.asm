.data
	...
	mensajePermutacion: .asciiz "Permutación seleccionada\n"
...
.text
	...
	main:
		...
		# Guarda en el registro $a0 la elección
		sw $a0, numeroEleccion
		
		# Condicionales respecto a la elección
	...
	miDivision: 
	miFactorial: 
	# Serie de etiquetas respectiva a cada operación
	permutacion: 
 	combinacion: 
	variacion: 